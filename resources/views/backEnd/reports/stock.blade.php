                            ...
                            <tbody>
                                ...
                                @foreach ($products as $key => $value)
                                    <tr>
                                        ...
                                        <td><button class="btn btn-primary adjust-stock" data-id="{{ $value->id }}">Adjust Stock</button></td>
                                    </tr>
                                    @php
                                        $stock += $value->stock;
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary save-stock">Save changes</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    $(document).ready(function() {
        ...
        $('body').on('click', '.adjust-stock', function() {
            let id = $(this).data('id');
            let url = "{{ route('get.stock.details') }}";
