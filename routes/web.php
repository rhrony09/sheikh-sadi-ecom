...
Route::group(['namespace' => 'Admin', 'middleware' => ['auth', 'lock', 'check_refer'], 'prefix' => 'admin'], function () {
    ...
    Route::get('get-stock-details', [OrderController::class, 'get_stock_details'])->name('get.stock.details');
    Route::post('/stock/adjust/{id}', [OrderController::class, 'adjust_stock'])->name('stock.adjust');
